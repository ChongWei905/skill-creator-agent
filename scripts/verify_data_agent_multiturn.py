...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Manual multi-turn verification for skill_creator via Ferry DataAgent.",
    )
    parser.add_argument(
        "--config",
...
async def main() -> int:
    ...
    print("DataAgent multi-turn verifier")
    ...
    print("Commands: /skills, /reset, /config, /quit")
    while True:
        try:
            user_input = input("\nYou> ").strip()
