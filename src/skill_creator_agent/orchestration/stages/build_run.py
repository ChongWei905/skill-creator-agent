...
class BuildRunAgent:
    ...
    async def run(
        ...
        *,
        ...
        draft = draft_manager.prepare_draft(skill_slug=approved.skill_slug or "generated-skill", build_version=build_version)
        ...
        spec = self.build_spec(runtime=draft_runtime, state=state, approved_plan=approved_plan, draft=draft)
